  ...
  return (
    <div className="site-shell">
      ...
      <PageHero
        ...
        lead="Cursive text generator: type a name, copy Mathematical Script Unicode, paste it. This page also has the A–Z alphabet if you only need one glyph—no font to install, and letters will not join like calligraphy."
      />
